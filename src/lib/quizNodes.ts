...
export const quiz: QuizNode[] = [
  ...
  },
  {
    ...
    text: "정말 힘들었겠다. 근데 이런 얘기는 나한테만 해야 되는 거 알지? 다른 사람들은 이런 얘기 들으면 좀 싫어할 수도 있을 것 같아. 나는 너를 믿으니까 안 그러지만. ", options: [
      {
        label: "맞아 ㅠㅠ 이런 애기 들어줄 사람은 오빠밖에 없어.. 내 친구들이나 부모님은 이야기를 안 들어줘 ",
        next: 3,
        score: 0,
      },
      {
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "잘들어줘서 고맙지만.. 우리가 벌써 비밀이 있을만큼 친해졌나?! 빠른것 같아 ",
        next: 8,
        score: 10,
      },
    ]
  },
  {
    id: 4,
    terminus: false,
    text: "아 그래? 그래도 다름 사람한테 이야기하는 건 조심해 속으로 무슨 생각 할지 몰라. 나한테는 언제든지 준비가되면 이야기해 줘 ㅎㅎ ",
    options: [
      {
        label: "응 고마워 오빠.. 내 얘기 들어줬으니까 나도 오빠 소원 하나 들어줄게! ",
        next: 7,
  ...
  },
  {
    id: 10,
    terminus: false,
    text: "고마워! 서로 비밀을 나누는 사이니까 어른들 한테는 우리가 어떤 사이인지 절대로 이야기하면 안돼! ㅎㅎ ",
    options: [
      {
  ...
  },
  {
    id: 16,
    terminus: false,
    text: "우리 진짜 이런 이야기 까지 나눌 수 있는 사이가 됐다니 너무 감동이야 나를 믿어줘서 고마워 (선물하기) ",
    options: [
      {
  ...
  },
  {
    id: 31,
    terminus: false,
    text: "이번에 새로 생긴 룸카페 가보는 건 어때? 거기 과자도 많고 아이스크림도 공짜로 준대! 넷플릭스도 볼 수 있어 ㅋㅋㅋ 부모님한테는 비밀로 하고 와 또 잔소리 하실테니까 ㅎ 그래? 근데 나 너 이름, 지역, 학교 다 아는데.. 우리 대화한 거 학교에 다 알려져도 괜찮아? ",
    options: [
      {
